...
def Create(url, headers, data):
    ...
    if ogapi.status_code == 201:
        ...
        module.exit_json(changed=False, response="Integration with name already exists!")
    else:
...
def main():
    ...
    module = AnsibleModule(
        argument_spec=dict(
            ...
            operation=dict(required=False, default='list', type='str', choices=["create", "list", "update", "updateactions", "createactions"]),
